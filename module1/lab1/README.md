...
You can follow the same procedure and clone your newly created repository. However, You can use intregrated GitHub feature in VS Code. This method will allow VS Code to access all of your repositories for your convenience.
